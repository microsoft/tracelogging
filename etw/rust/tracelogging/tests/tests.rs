...
fn write_event() {
    ...
    tlg::write_event!(
        ...
        strz16("zstr16-a", &[97]),
        strz16("zstr16-0", &[0]),
        strz16("zstr16-a0", &[97, 0]),
        strz16("zstr16-0a", &[0, 97]),
        strz16("zstr16-a0a", &[97, 0, 97]),
        strz8("zstr8-", ""),
        strz8("zstr8-a", "a"),
        strz8("zstr8-0", "\0"),
        strz8("zstr8-a0", "a\0"),
        strz8("zstr8-0a", "\0a"),
        strz8("zstr8-a0a", "a\0a"),
        strz8_cp1252("zstr8e-", ""),
        strz8_cp1252("zstr8e-a", "a"),
        strz8_cp1252("zstr8e-0", "\0"),
        strz8_cp1252("zstr8e-a0", "a\0"),
        strz8_cp1252("zstr8e-0a", "\0a"),
        strz8_cp1252("zstr8e-a0a", "a\0a"),
        char8_cp1252("A", &b'A'),
    );
    ...
    tlg::write_event!(
        ...
        "UnicodeString",
        char8_cp1252("A", &b'A'),
        strz16("scalar", &Vec::from_iter("zutf16".encode_utf16())),
        char8_cp1252("A", &b'A'),
    );
