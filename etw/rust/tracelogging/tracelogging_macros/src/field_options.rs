...
/// List MUST be strcmp-sorted by name (for binary search).
...
pub static FIELD_OPTIONS: &[Opt] = &[
    ...
    Opt::new("ipv6",                    U8_PATH,    I::Binary,     O::IPv6,          Counted,    0),
    Opt::new("ipv6c",                   U8_PATH,    I::BinaryC,    O::IPv6,          Counted,    0),
    ...
    Opt::new("str",                     U8_PATH,    I::Str8,       O::Utf8,          Counted,    0),
    ...
    Opt::new("str_cp1252",              U8_PATH,    I::Str8,       O::Default,       Counted,    0),
    Opt::new("str_json",                U8_PATH,    I::Str8,       O::Json,          Counted,    0),
    Opt::new("str_xml",                 U8_PATH,    I::Str8,       O::Xml,           Counted,    0),
    Opt::new("struct",                  &[],        I::Struct,     O::Default,       Struct,     0),
    Opt::new("systemtime",              I64_PATH,   I::FileTime,   O::Default,       SystemTime, 0),
    Opt::new("systemtime_utc",          I64_PATH,   I::FileTime,   O::DateTimeUtc,   SystemTime, 0),
    Opt::new("sz",                      U8_PATH,    I::Sz8,        O::Utf8,          Sz,         0),
    Opt::new("sz16",                    U16_PATH,   I::Sz16,       O::Default,       Sz,         0),
    Opt::new("sz16_json",               U16_PATH,   I::Sz16,       O::Json,          Sz,         0),
    Opt::new("sz16_xml",                U16_PATH,   I::Sz16,       O::Xml,           Sz,         0),
    Opt::new("sz_cp1252",               U8_PATH,    I::Sz8,        O::Default,       Sz,         0),
    Opt::new("sz_json",                 U8_PATH,    I::Sz8,        O::Json,          Sz,         0),
    Opt::new("sz_xml",                  U8_PATH,    I::Sz8,        O::Xml,           Sz,         0),
    ...
    Opt::new("win_filetime_utc",        I64_PATH,   I::FileTime,   O::DateTimeUtc,   Scalar,     0),
    Opt::new("win_filetime_utc_slice",  I64_PATH,   I::FileTime,   O::DateTimeUtc,   Slice,      0),
